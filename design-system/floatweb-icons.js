/**
 * Floatweb Icon Library v1.0
 * Modern SVG icons for all templates
 * Based on Lucide icons (clean, consistent, MIT licensed)
 */

const FloatwebIcons = {
    // Communication
    phone: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.22.92.41 1.81.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.96.29 1.86.48 2.81.7A2 2 0 0 1 22 16.92z"/></svg>`,
    ...
    // Services - Trades
    droplet: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.69l5.74 5.88a1 1 0 0 1 .26.67v8.76a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-8.76a1 1 0 0 1 .26-.67L12 2.69z"/></svg>`,
    
    flame: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-3-4-3-7a5 5 0 0 1 10 0c0 3-1.928 4.857-3 7-.5 1-1 1.62-1 3a2.5 2.5 0 0 0 2.5 2.5h-7z"/></svg>`,
    
    bath: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21h6v-2H9v2z"/><path d="M9 17h6v-5a3 3 0 0 0-6 0v5z"/><path d="M12 2a7 7 0 0 0-7 7c0 2 1 3 1 5v1h12v-1c0-2 1-3 1-5a7 7 0 0 0-7-7z"/></svg>`,
    ...
    sparkle: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z"/></svg>`,
    ...
    // Food/Restaurant
    utensils: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 2v7c0 1.1-.9 2-2 2h-4a2 2 0 0 1-2-2V2"/><path d="M15 2v20"/></svg>`,
    
    wine: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 21h8"/><path d="M12 21v-5"/><path d="M12 16a5 5 0 0 1 5-5h0V4a2 2 0 0 0-2-2h-6a2 2 0 0 0-2 2v7h0a5 5 0 0 1 5 5z"/></svg>`,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = FloatwebIcons;
}

// Usage in HTML:
// <script src="floatweb-icons.js"></script>
// <script>document.getElementById('icon').innerHTML = FloatwebIcons.phone;</script>
